      ...
      <div class="navbar-start">
        <div class="dropdown">
          ...
          >
            ...
            <li>
              <router-link :to="{ name: 'userapi' }">UserApi</router-link>
            </li>
            <li>
              <router-link :to="{ name: 'storepage' }">Test Store</router-link>
            </li>
          </ul>
        </div>
      </div>
      <div class="navbar-center">
        <a class="btn btn-ghost normal-case text-xl">Admin UI</a>
      </div>
